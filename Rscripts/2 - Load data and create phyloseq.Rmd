...
# Packages
```{r}
library(phyloseq);library(tidyr);library(dplyr);library(openxlsx); library(textshape)
```
...
ntaxa(Final.ps); ntaxa(ps_aggl) # 85 ARGs now (ARGCluster 90 level) vs 233 ARGs 
