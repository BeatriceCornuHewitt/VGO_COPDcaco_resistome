...
# input for ps object 
here()
metafile <- here("Data//Raw//VGOCOPD_metadata_completed_20210429alx_correctFormulaColumnTU.xlsx.tab")
argclusterfile <- here("Data//Raw//ResfinderClustersFinal_Resfinder20200127_inclGeneLen+pheno_20201206b.tab")
argmappingfile <- here("Data//Raw//02e_TotalResfinderMapped_v3.tab")
```
...
LUR_RF_residential_predictions  <- read.xlsx("Input_files//LUR_RF_residential_predictions_copdstatus.xlsx")
