...
# lfc_(Intercept) and lfc_copdcaco1: lfc = log fold changes in microbial abundance between the reference group (Intercept) and the group defined by the variable copdcaco1. A positive LFC indicates an increase in abundance, while a negative LFC indicates a decrease.
