*** LUR and RF models and the resistome ***
...
LUR_RF_residential_predictions  <- read.xlsx("Output_files//LUR_RF_models//LUR_RF_residential_predictions.xlsx")
...
LUR_RF_residential_predictions_copdstatus <- read.xlsx("Output_files//LUR_RF_models//LUR_RF_residential_predictions_copdstatus.xlsx")
...
PCoA.plot.E.coli_LUR_estimates <- PCoA.plot.E.coli_LUR_estimates +
  geom_text(x = -0.44, y = 0.55, label = paste("PERMANOVA, p-value =", E.coli_permanova_pval), size = 3.7, color = "black")
PCoA.plot.E.coli_LUR_estimates

ggsave("Output_files//PCoAs//E.coli_LURmodelled_PCoA_plot.png", PCoA.plot.E.coli_LUR_estimates, width = 9, height = 6, dpi = 1000)
```
...
# Add the p-value annotation to the PCoA plot using geom_text
PCoA.plot.E.coli_LUR_estimates <- PCoA.plot.E.coli_LUR_estimates +
  geom_text(x = -0.3, y = 0.55, label = paste("PERMANOVA, p-value =", E.coli_permanova_pval), size = 3.7, color = "black")
PCoA.plot.E.coli_LUR_estimates

ggsave("Output_files//PCoAs//E.coli_LURmodelled_PCoA_plot.png", PCoA.plot.E.coli_LUR_estimates, width = 9, height = 6, dpi = 300)

# LUR-modelled Staph
set.seed(123)
Staph_permanova_result <- adonis2(BC.distance.LUR.RF~ ARG.cluster.LUR.RF.df$Staph_LUR_estimates, permutations = 999)
Staph_permanova_pval <- Staph_permanova_result$`Pr(>F)`[1]

PCoA.plot.Staph_LUR_estimates<- plot_ordination(ARGcluster.aggl.noblanks.LUR.RF.estimates.QUANT, ARGcluster.aggl.noblanks.LUR.RF.estimates.QUANT.PCoA, color = "Staph_LUR_estimates", shape="Staph_LUR_estimates") +
    ggtitle("BC PCoA (fully corrected and rarefied ARG counts, 90% identity clustered) - \ncoloured by Staph exposure quantiles (LUR-modelled)") +
  labs(legend="E. coli (LUR-modelled) exposure quantiles")+
    geom_point(size =2) +
    geom_text( aes( label=row.names(ARGcluster.aggl.noblanks.LUR.RF.estimates.QUANT@sam_data),hjust=-0.3, vjust=-0.5 ), size = 2) +
  theme(plot.title = element_text(size = 12))+ # adjusting size of title text
...
# Add the p-value annotation to the PCoA plot using geom_text
PCoA.plot.Staph_LUR_estimates <- PCoA.plot.Staph_LUR_estimates +
  geom_text(x = -0.3, y = 0.6, label = paste("PERMANOVA, p-value =", Staph_permanova_pval), size = 3.7, color = "black")
PCoA.plot.Staph_LUR_estimates
# Save PCoA
ggsave("Output_files//PCoAs//Staph_LURmodelled_PCoA_plot.png", PCoA.plot.Staph_LUR_estimates, width = 9, height = 6, dpi = 300)

# LUR-modelled tetW
set.seed(123)
tetW_permanova_result <- adonis2(BC.distance.LUR.RF~ ARG.cluster.LUR.RF.df$tetW_LUR_estimates, permutations = 999)
tetW_permanova_pval <- tetW_permanova_result$`Pr(>F)`[1]
...
# Add the p-value annotation to the PCoA plot using geom_text
PCoA.plot.tetW_LUR_estimates <- PCoA.plot.tetW_LUR_estimates +
  geom_text(x = -0.3, y = 0.6, label = paste("PERMANOVA, p-value =", tetW_permanova_pval), size = 3.7, color = "black")
PCoA.plot.tetW_LUR_estimates

ggsave("Output_files//PCoAs//PCoA.plot.tetW_LUR_estimates.png", PCoA.plot.tetW_LUR_estimates, width = 9, height = 6, dpi = 300)

# LUR-modelled mecA
set.seed(123)
mecA_permanova_result <- adonis2(BC.distance.LUR.RF~ ARG.cluster.LUR.RF.df$mecA_LUR_estimates, permutations = 999)
mecA_permanova_pval <- mecA_permanova_result$`Pr(>F)`[1]
...
# Add the p-value annotation to the PCoA plot using geom_text
PCoA.plot.mecA_LUR_estimates <- PCoA.plot.mecA_LUR_estimates +
  geom_text(x = -0.3, y = 0.55, label = paste("PERMANOVA, p-value =", mecA_permanova_pval), size = 3.7, color = "black")
PCoA.plot.mecA_LUR_estimates

ggsave("Output_files//PCoAs//mecA_LURmodelled_PCoA_plot.png", PCoA.plot.mecA_LUR_estimates, width = 9, height = 6, dpi = 300)


# RF-modelled E. coli
set.seed(123)
E.coli_RF_permanova_result <- adonis2(BC.distance.LUR.RF~ ARG.cluster.LUR.RF.df$E.coli_RF_predictions, permutations = 999)
E.coli_RF_permanova_pval <- E.coli_RF_permanova_result$`Pr(>F)`[1]
# p-value = 0.292 - no significant differences in group centroids-  We can conclude that our groups (quartiles of e. coli (LUR-modelled) exposure present homogeneity among group dispersions (compositions vary similarly) and also they have very similar compositions (adonis not significant)
...
# Add the p-value annotation to the PCoA plot using geom_text
PCoA.plot.E.coli_RF_estimates <- PCoA.plot.E.coli_RF_estimates +
  geom_text(x = -0.3, y = 0.55, label = paste("PERMANOVA, p-value =", E.coli_RF_permanova_pval), size = 3.7, color = "black")
PCoA.plot.E.coli_RF_estimates

ggsave("Output_files//PCoAs//E.coli_RFmodelled_PCoA_plot.png", PCoA.plot.E.coli_RF_estimates, width = 9, height = 6, dpi = 300)


# RF-modelled Staph
set.seed(123)
Staph_RF_permanova_result <- adonis2(BC.distance.LUR.RF~ ARG.cluster.LUR.RF.df$Staph_RF_predictions, permutations = 999)
Staph_RF_permanova_pval <- Staph_RF_permanova_result$`Pr(>F)`[1]
...
# Add the p-value annotation to the PCoA plot using geom_text
PCoA.plot.Staph_RF_estimates <- PCoA.plot.Staph_RF_estimates +
  geom_text(x = -0.3, y = 0.58, label = paste("PERMANOVA, p-value =", Staph_RF_permanova_pval), size = 3.7, color = "black")
PCoA.plot.Staph_RF_estimates
# Save PCoA
ggsave("Output_files//PCoAs//Staph_RFmodelled_PCoA_plot.png", PCoA.plot.Staph_RF_estimates, width = 9, height = 6, dpi = 300)

# RF-modelled tetW
set.seed(123)
tetW_RF_permanova_result <- adonis2(BC.distance.LUR.RF~ ARG.cluster.LUR.RF.df$tetW_RF_predictions, permutations = 999)
tetW_RF_permanova_pval <- tetW_RF_permanova_result$`Pr(>F)`[1]
...
# Add the p-value annotation to the PCoA plot using geom_text
PCoA.plot.tetW_RF_estimates <- PCoA.plot.tetW_RF_estimates +
  geom_text(x = -0.3, y = 0.49, label = paste("PERMANOVA, p-value =", tetW_RF_permanova_pval), size = 3.7, color = "black")
PCoA.plot.tetW_RF_estimates

ggsave("Output_files//PCoAs//PCoA.plot.tetW_RF_estimates.png", PCoA.plot.tetW_RF_estimates, width = 9, height = 6, dpi = 300)

# RF-modelled mecA
set.seed(123)
mecA_RF_permanova_result <- adonis2(BC.distance.LUR.RF~ ARG.cluster.LUR.RF.df$mecA_RF_predictions, permutations = 999)
mecA_RF_permanova_pval <- mecA_RF_permanova_result$`Pr(>F)`[1]
...
# Add the p-value annotation to the PCoA plot using geom_text
PCoA.plot.mecA_RF_estimates <- PCoA.plot.mecA_RF_estimates +
  geom_text(x = -0.3, y = 0.50, label = paste("PERMANOVA, p-value =", mecA_RF_permanova_pval), size = 3.7, color = "black")
PCoA.plot.mecA_RF_estimates

ggsave("Output_files//PCoAs//mecA_RFmodelled_PCoA_plot.png", PCoA.plot.mecA_RF_estimates, width = 9, height = 6, dpi = 300)
